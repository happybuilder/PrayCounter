 ...
 */
public class ClearableEditText extends View {
	...
	private void init(AttributeSet attrs, int defStyle) {
		// Load attributes
		final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ClearableEditText, defStyle, 0);

		mExampleString = a.getString(R.styleable.ClearableEditText_exampleString);
		mExampleColor = a.getColor(R.styleable.ClearableEditText_exampleColor, mExampleColor);
		// Use getDimensionPixelSize or getDimensionPixelOffset when dealing
		// with
		// values that should fall on pixel boundaries.
		mExampleDimension = a.getDimension(R.styleable.ClearableEditText_exampleDimension, mExampleDimension);

		if (a.hasValue(R.styleable.ClearableEditText_exampleDrawable)) {
			mExampleDrawable = a.getDrawable(R.styleable.ClearableEditText_exampleDrawable);
